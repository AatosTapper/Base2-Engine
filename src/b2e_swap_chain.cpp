...
namespace b2e 
{
B2eSwapChain::B2eSwapChain(B2eDevice &deviceRef, VkExtent2D extent)
    : device{deviceRef}, windowExtent{extent} {
  init();
}

B2eSwapChain::B2eSwapChain(B2eDevice &deviceRef, VkExtent2D extent, std::shared_ptr<B2eSwapChain> previous)
...
VkResult B2eSwapChain::acquire_next_image(uint32_t *imageIndex) {
  vkWaitForFences(
      device.device(),
      1,
...
VkResult B2eSwapChain::submit_command_buffers(
...
void B2eSwapChain::createSwapChain() {
...
void B2eSwapChain::createImageViews() {
...
void B2eSwapChain::createRenderPass() {
...
void B2eSwapChain::createFramebuffers() {
...
void B2eSwapChain::createDepthResources() {
...
void B2eSwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR B2eSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR B2eSwapChain::chooseSwapPresentMode(
...
VkExtent2D B2eSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat B2eSwapChain::findDepthFormat() {
